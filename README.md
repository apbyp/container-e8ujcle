...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-e8ujcle.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-e8ujcle.containers.anotherwebservice.com/
...
```
git clone git@github.com:ayushprobroyopython/container-e8ujcle.git
cd container-e8ujcle
```
...
```
docker attach container-e8ujcle
```
